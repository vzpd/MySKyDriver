...
var treeMenu = [
	{ level:1, name:"全部文件"},
	{ level:2, name:"图片", ico:"images/icon_default.gif",link:"students/Students_query.action"},
	{ level:2, name:"文档", ico:"images/icon_default.gif",link:"students/Students_query.action"},
	{ level:2, name:"音频", ico:"images/icon_default.gif",link:"students/Students_query.action"},
	{ level:2, name:"视频", ico:"images/icon_default.gif",link:"students/Students_query.action"},
	{ level:2, name:"其他", ico:"images/icon_default.gif",link:"students/Students_query.action"},
	{ level:1, name:"回收站"},
...
var link = "";
//根目录
tree.add(0,-1,'用户中心', null, null, null, '', '');
var count = 0;
