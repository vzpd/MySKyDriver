		...
		<div id="main">
			<div id="mainBg">
				<div id="mainPanel">
					...
					<div id="right">
						<form name="loginForm" action="UserAction!login"
							method="post">
							<!-- start of login form -->
							<div id="welcome">
							...
							<div id="user-name">
								<span class="item">用户名:</span> <span><input type="text"
									name="user.userName" class="form-input"></span>
							</div>
							<div id="user-password">
								<span class="item">密&nbsp;&nbsp;&nbsp;码:</span> <span
									class="input"><input type="password"
									name="user.userPassword" class="form-input"></span>
							</div>
							<div id="button-group">
